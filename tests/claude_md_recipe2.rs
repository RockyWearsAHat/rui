#![doc = "Verify Recipe 2 (X11 Backend) references in CLAUDE.md are grounded in reality"]

//! Verify that Recipe 2 (X11 Backend Implementation) section references in CLAUDE.md
