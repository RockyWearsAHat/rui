...
impl PanelWindowInner {
    ...
    /// Tint a label's text (not yet implemented on Windows).
    ...
    /// Set the panel's style (not yet implemented on Windows).
    pub fn style(
        &self,
    ...
    /// Tint a button's bezel (not yet implemented on Windows).
